...
function areCoordsNear(coords1, coords2, toleranceKm = 1) {
    ...
    // Non aggiungiamo log qui per mantenere la funzione pura.
    // Il logging andra' fatto nel punto in cui la funzione viene chiamata.
    
    return distance < toleranceKm;
}

console.log("--- [DEBUG] Exporting from geo.utils.js:", { areCoordsNear });
module.exports = { areCoordsNear };