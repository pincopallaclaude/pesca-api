    ...
    try {
        ...
        for (const wwoDay of wwoDailyData) {
            ...
            const hourlyClientFormat = omHourly.map(h => {
                ...
                // === CORREZIONE REGRESSIONE ===
                // Inizializziamo a 'N/D' (Stringa) invece che a null
                let currentSpeedKn = 'N/D'; // Inizializzazione corretta
                // ============================
                ...
                if (isPosillipo && stormglassData && stormglassData[date]) {
                    ...
                    if (sgHourData && sgHourData.currentSpeed != null) {
                        ...
                        // Assegniamo una STRINGA formattata
                        currentSpeedKn = speedInKn.toFixed(1); // Conversione in stringa
                    }
                }
            ...
            // NON togliere per mantenere la logica precedente
