...
async function fetchAndProcessForecast(location) {
    ...
    // TERZA MODIFICA: Usiamo le coordinate arrotondate (toFixed(3)) per il fetch API come suggerito 
    // nelle istruzioni precedenti per uniformare la richiesta su WWO/Stormglass/OpenMeteo
