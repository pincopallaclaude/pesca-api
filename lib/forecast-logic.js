...
function calculateHourlyPescaScore(params) {
    ...
    // ==========================================================
    // ✨ FIX DEBUG: Log dettagliato per verificare i parametri
    // ==========================================================
    ...
    console.log(`[Score Calc DEBUG] Ora: ${hour}:00. Parametri Ricevuti:`);
    console.log(`  - Pressione/Trend: ${pressure.toFixed(1)} / ${trendPressione}`);
    ...
    console.log(`  - Corrente (Speed/Dir): ${currentSpeedDisplay} / ${currentDirectionStr}`);
    ...
    console.log(`[Score Calc DEBUG] Score Corrente: ${currentPoints.toFixed(1)}, Score Totale Finale: ${score.toFixed(1)}`);
