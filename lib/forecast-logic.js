...
const { areCoordsNear, getStatusLabel, degreesTo16PointDirection } = weatherUtils;
const { capitalize, formatTimeToHHMM, convertWmoToWwoCode, getSeaStateAcronym, getWeatherDescription, getMeteoIconFromCode } = formatter;
