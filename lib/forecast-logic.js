    ...
    try {
        ...
        for (const wwoDay of wwoDailyData) {
            ...
            finalForecast.push({
                ...
                dailyHumidity: dailyAvgHumidity, // Ora solo il numero
                dailyPressure: dailyAvgPressure, // Ora solo il numero
                dailyWindSpeedKn: dailyWindSpeedKn, // Numero, in Nodi
                dailyWindDirectionDegrees: dailyWindDirectionDegrees, // Numero, 0-360
                ...
                // ===> DATI AGGIUNTIVI PER LA TABELLA SETTIMANALE <===
                dailyWeatherCode: dailyWeatherCode,
