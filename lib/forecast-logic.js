...
async function getUnifiedForecastData(location) {
    ...
    try {
        ...
        for (const wwoDay of wwoDailyData) {
            ...
            // La vecchia logica viene rimossa
        ...
        // [PHANTOM TRIGGER] Avvia l'analisi AI in background senza attendere il risultato.
        // Usiamo un setTimeout(..., 0) per assicurarci che la risposta HTTP venga inviata prima.
        setTimeout(() => {
            runProactiveAnalysis(apiResponse, normalizedLocation);
        }, 0);        
