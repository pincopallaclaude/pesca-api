...
const weatherUtils = require('./utils/wmo_code_converter.js');
...
// --- MODIFICA (sostituisci l'intero blocco 'utilities' e la sua destrutturazione) ---
// [REFACTOR] The monolithic 'utilities' object has been removed.
// All utility functions are now called directly from the imported modules.
// The only function that remains here is 'areCoordsNear' because it is highly
// specific to the forecast logic of checking for "Posillipo".

/**
 * Calculates the distance between two coordinates (Haversine formula) and checks if they are close.
 * This is kept here as it's a domain-specific utility for this logic file.
 * @param {string} coords1 - "lat,lon" of the first coordinate.
 * @param {string} coords2 - "lat,lon" of the second coordinate.
...
function areCoordsNear(coords1, coords2, toleranceKm = 1) {
    ...
    log(`Distanza da Posillipo: ${distance.toFixed(3)} km`, 'areCoordsNear DEBUG');
