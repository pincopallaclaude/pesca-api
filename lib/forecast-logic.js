...
function calculateHourlyPescaScore(params) {
    ...
    // console.log('----------------------------------------------------'); // Rimosso su richiesta
    // ==========================================================
    ...
    // console.log(`[Score Calc DEBUG] Score Corrente: ${currentPoints.toFixed(1)}, Score Totale Finale: ${score.toFixed(1)}`); // Rimosso su richiesta utente
