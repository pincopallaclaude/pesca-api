...
function calculateHourlyPescaScore(params) {
    ...
    // Il parametro currentSpeedKn è ora disponibile
    const { 
    ...
    // --- NUOVA LOGICA VENTO (Pesi variabili basati su Temp. Acqua) ---
    ...
    // --- NUOVA LOGICA TEMPERATURA ACQUA (Pesi differenziati) ---
...
// --- FUNZIONE PRINCIPALE (RINOMINATA PER EVITARE REGRESSIONE) ---
async function getUnifiedForecastData(location) {
    ...
    try {
        ...
        for (const wwoDay of wwoDailyData) {
            ...
            // Uniamo i dati Open-Meteo e Stormglass
            ...
            // Calcolo dello score basato sui dati arricchiti
            ...
            // Creazione del formato orario per il client basato sui dati arricchiti
...
module.exports = { getUnifiedForecastData, myCache };
