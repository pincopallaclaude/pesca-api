...
// NUOVA FUNZIONE: Restituisce la descrizione testuale dello stato del mare
export function getSeaStateDescription(waveHeight) {
    if (waveHeight === null || isNaN(waveHeight)) return 'N/D';
...
export {
    capitalize,
    getSeaStateAcronym,
    getSeaStateDescription, // <-- AGGIUNTO ALL'EXPORT
    formatTimeToHHMM,
