...
/**
 * Provides a textual weather description from a WWO code.
 * @param {string | number} wwoCode - The World Weather Online code.
 * @returns {string} - The Italian weather description.
 */
...
module.exports = { 
  ...
  getWeatherDescription // Export the new function
};