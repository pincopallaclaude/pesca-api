// /lib/domain/weather-aggregator.service.js
...
import { getMostSignificantWeatherCode, findBestTimeWindow } from './weather-utils.js';

/**
 * Assembla i dati grezzi dalle API in un formato unificato per il frontend.
 */
export function assembleForecastData(wwoDailyData, openMeteoHourlyData, stormglassData) {
    ...
    return {
        fonti: "Open-Meteo & WorldWeatherOnline", // Nota: Stormglass viene aggiunto dopo, nell'orchestratore
