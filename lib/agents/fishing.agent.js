...
  // === REACT LOOP ===
  for (let iteration = 0; iteration < MAX_ITERATIONS; iteration++) {
      ...
      // CORREZIONE: Usiamo logger.log al posto di logger.info e logger.debug
      logger.log(`[Gemini-DEBUG] Payload Size: ${payloadBytes} bytes`);
      logger.log(`[Gemini-DEBUG] Request Head (first 500 chars): ${payloadString.substring(0, 500)}...`);
