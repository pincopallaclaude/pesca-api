...
// [REFACTOR] Import the necessary utility directly instead of receiving it as a parameter.
const { degreesTo16PointDirection } = require('../utils/wmo_code_converter.js');
        ...
        try {
            ...
            response.data.hours.forEach(hourData => {
                ...
                const directionStr = directionDeg !== null 
                    ? degreesTo16PointDirection(directionDeg) // Now calls the imported function directly.
                    : 'N/D';
                ...
                dataByDay[date].push({
                    hour: hour,
                    currentSpeedKn: speedInKnots !== null ? speedInKnots : 'N/D',
