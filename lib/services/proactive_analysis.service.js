...
import { POSILLIPO_COORDS } from '../utils/constants.js'; // CAMBIATO: Importa la costante dal nuovo file
import geoUtils from '../utils/geo.utils.js'; // NUOVO IMPORT
...
async function runProactiveAnalysis(forecastData, locationKey) {
    ...
    } else if (geoUtils.areCoordsNear(locationKey, POSILLIPO_COORDS)) { // USA LA FUNZIONE CORRETTA
