...
export async function runProactiveAnalysis(fullForecastData, normalizedLocation) {
    ...
    try {
        ...
        console.log("--- DEBUG: Contenuto di firstDayForecast ---");
        console.log(JSON.stringify(firstDayForecast, null, 2));
        console.log("--- FINE DEBUG ---");
        throw new Error("DEBUG: Esecuzione bloccata per ispezione oggetto."); // Blocchiamo qui
