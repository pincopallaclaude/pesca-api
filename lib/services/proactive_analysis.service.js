    ...
    try {
        ...
        try {
            ...
            if (parsedJson && parsedJson.analysis) {
                ...
                console.log('[Proactive-AI] Estrazione da JSON "analysis" riuscita.');
            } else {
                // Se il JSON è valido ma non ha la chiave 'analysis', usiamo il testo grezzo
                finalAnalysis = rawAiResponse;
                console.log('[Proactive-AI] Chiave "analysis" non trovata nel JSON. Uso fallback su testo grezzo.');
            }
        } catch (e) {
