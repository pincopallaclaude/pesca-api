...
async function _initialize() {
    try {
        ...
        if (process.env.CHROMA_DB_HOST && process.env.CHROMA_API_KEY) {
            ...
            logger.log(`[ChromaDB] ☁️ Rilevata configurazione Cloud. Connessione a TENANT...`);
            ...
            // --- CONNESSIONE LOCALE (utilizzando variabili d'ambiente se presenti) ---
            const host = process.env.CHROMA_DB_HOST || '127.0.0.1';
            const port = process.env.CHROMA_DB_PORT || '8001';
