...
async function _initialize() {
    try {
        ...
        // La chiamata client.heartbeat() è stata rimossa per evitare il fail-fast,
        // lasciando che sia getOrCreateCollection a gestire il primo tentativo di connessione.
        logger.log(`[ChromaDB] ✅ Client creato. Tentativo di ottenere la collection...`);
