...
async function _initialize() {
    try {
        ...
        try {
            ...
            // Gestione ampliata: verifica sia 404 che risposte con body che indica "does not exist"
            ...
            if (isNotFoundError) {
                ...
                // Se l'errore è diverso, è un problema reale (e.g. connessione fallita, server non risponde)
