...
// **[FIX FINALE PER TYPERROR]**
// Importiamo l'oggetto modulo completo.
const genai_module = require('@google/generative-ai');

// Tentiamo di trovare il costruttore GoogleGenAI:
// 1. Controlliamo se è nel campo .default (tipico dei pacchetti ES importati con require).
// 2. Usiamo GoogleGenAI se è presente nell'oggetto principale.
// 3. Altrimenti, usiamo l'oggetto principale (se è l'esportazione di default).
const GoogleGenAI = genai_module.default?.GoogleGenAI || genai_module.GoogleGenAI || genai_module;
