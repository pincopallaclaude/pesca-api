...
// Importiamo l'oggetto completo e poi destrutturiamo GoogleGenAI
const { GoogleGenAI } = require('@google/generative-ai');

// Inizializzazione del client con la chiave API da .env
// NOTA: A seconda della versione esatta di @google/generative-ai, potresti dover usare:
// const { GoogleGenAI } = require('@google/generative-ai');
// const ai = new GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY });
// Oppure (se non usi la destrutturazione con require):
// const genai = require('@google/generative-ai');
// const ai = new genai.GoogleGenAI(process.env.GEMINI_API_KEY);
//
// Manteniamo la versione che segue il pattern moderno per l'importazione CJS:
