...
// Utilizziamo la destrutturazione per estrarre ESPLICITAMENTE la classe GoogleGenAI 
// direttamente dall'oggetto principale del modulo, la forma più comune e robusta
// per gli SDK moderni in un contesto CommonJS (`require`).
