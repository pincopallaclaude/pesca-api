...
// Usiamo genai_module.GoogleGenAI per accedere al costruttore,
// risolvendo l'errore "GoogleGenAI is not a constructor".
const ai = new genai_module.GoogleGenAI(process.env.GEMINI_API_KEY);
