...
// Tentiamo di trovare il costruttore GoogleGenAI nell'oggetto principale, 
// o nel campo 'default', o direttamente nell'oggetto, se è l'esportazione predefinita.
const GoogleGenAI = genai_module.GoogleGenAI || genai_module.default || genai_module;
