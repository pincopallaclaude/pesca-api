...
// Dato che la destrutturazione diretta (const { GoogleGenAI } = require(...)) fallisce,
// forziamo l'importazione prendendo l'oggetto modulo completo.
const genai_module = require('@google/generative-ai');

// In ambienti CommonJS ostili, l'esportazione di default è l'unica cosa valida.
// La classe GoogleGenAI è spesso accessibile come l'oggetto principale stesso (se è l'esportazione di default)
// o tramite il campo .default (se è un modulo ES).
const GoogleGenAI = genai_module.default || genai_module;

// Inizializzazione del client con la chiave API da .env
// Usiamo la variabile GoogleGenAI che ora contiene il costruttore corretto.
