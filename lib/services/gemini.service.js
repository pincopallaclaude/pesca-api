...
// **[FIX CORREZIONE ERRORE FINALE]**
// Importiamo l'esportazione di default (che è il costruttore GoogleGenAI)
// In CommonJS, quando un modulo esporta un default, `require` restituisce il default.
const GoogleGenAI = require('@google/generative-ai');

// Inizializzazione del client con la chiave API da .env
// Usiamo la variabile GoogleGenAI ottenuta direttamente da require.
