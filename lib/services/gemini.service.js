...
const genAI = new GoogleGenerativeAI(process.env.GEMINI_API_KEY); // Inizializzazione standard
...
async function generateWithBestModel(request) {
    ...
    throw lastError; // Se tutti falliscono, lancia l'ultimo errore registrato
}
