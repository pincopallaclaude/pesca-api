...
async function queryKnowledgeBase(queryText, nResults = 5) {
    ...
    try {
        ...
        const results = neighbors.map((neighborIndex, i) => ({
            ...
            // La distanza coseno (HNSW) è tra 0 (simili) e 2 (opposti).
            // La similarità è 1 - distanza/2 (oppure 1 - distanza se la distanza è normalizzata a [0, 1] che hnswlib-node non garantisce,
            // ma 1 - distanza è spesso usato per rappresentare il "punteggio di similarità"
