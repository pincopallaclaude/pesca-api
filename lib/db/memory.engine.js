...
async function initChroma() {
  try {
    // --- INIZIO BLOCCO RIPRISTINATO E CORRETTO ---
    ...
    chromaClient = new ChromaClient({ path: CHROMA_URL }); // L'opzione 'path' qui funziona per gli URL
    // --- FINE BLOCCO RIPRISTINATO E CORRETTO ---
