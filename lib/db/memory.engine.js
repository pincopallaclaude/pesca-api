...
export async function findSimilarEpisodes(currentConditions, limit = 5) {
    ...
    try {
        ...
        // ChromaDB Query (Manteniamo l'endpoint che DEVE funzionare con il nome della collezione)
        const response = await axios.post(`${CHROMA_API_URL}/collections/fishing_episodes/query`, {
            ...
            // Rendo espliciti i dati che vogliamo ricevere per aumentare la compatibilità
