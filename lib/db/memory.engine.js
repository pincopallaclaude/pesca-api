...
let chromaCollectionId = null; // Nuovo: ID interno della collezione per query
...
async function initChroma() {
    try {
        ...
        // NUOVO: Recupera l'ID della collezione per usarlo nelle query (risolve InvalidUUID)
